...
class _PlanCreatorScreen extends State<PlanCreatorScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: const Text('Master Plans Devi')),
        ...
        child: Material(
          ...
          child: TextField(
              ...
              decoration: const InputDecoration(
                  labelText: 'Tambahkan Plan untuk hari ini', contentPadding: EdgeInsets.all(20)),
    ...
    if (plans.isEmpty) {
      return Column(
          ...
          children: <Widget>[
            ...
            Text('Tidak ada rencana sama sekali',
